...
import de.njlent.wurstmeteor.modules.combat.WindChargeKeyModule;
...
import de.njlent.wurstmeteor.modules.render.PlayerSonarModule;
...
public class WurstMeteorAddon extends MeteorAddon {
    ...
    public void onInitialize() {
        ...
        modules.add(new WindChargeKeyModule());
        ...
        modules.add(new PlayerSonarModule());
